...
export function Favorites() {
  ...
  return(
    <View style={styles.container}>
      ...
      <Input titlePlaceHolder="Insira um Produto para seus Favoritos!" onChangeText={ setNewProduto } />

      <Button title="Adicionar Produto" onPress={ handleAddNewProduto } />

      <Text style={styles.minhaLista}> Minha Lista</Text>
